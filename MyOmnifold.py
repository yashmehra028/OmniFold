...
def omnifold(theta0,theta_unknown_S,iterations,model,verbose=0):
    ...
    #Initial weights
    particle_level_weights = np.ones(len(theta0_G))
    detector_level_weights = particle_level_weights
    ...
    for i in range(iterations):
        ...
        weights_1 = np.concatenate((detector_level_weights, np.ones(len(theta_unknown_S))))
